      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-56">
          ...
          <DropdownMenuItem
            ...
            onClick={() =>
              window.open('https://github.com/fvitas/fontblitz/issues/new?template=%F0%9F%9A%80-feature-request.md')
            }>
          ...
          <DropdownMenuItem
            className="cursor-pointer"
            onClick={() =>
              window.open('https://github.com/fvitas/fontblitz/issues/new?template=%F0%9F%90%9B-bug-report.md')
            }>
          ...
          <DropdownMenuItem className="cursor-pointer">
            <div className="flex items-center gap-2" onClick={() => window.open('https://ko-fi.com/filipvitas')}>
      ...
      <Dialog open={aboutOpen} onOpenChange={setAboutOpen}>
        <DialogContent>
          <DialogHeader className="text-left">
            <DialogTitle>FontBlitz</DialogTitle>
          ...
          <div className="mt-4 space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <span>
                <a
                  href="https://github.com/fvitas/fontblitz"
                  rel="noreferrer"
                  target="_blank"
                  className="flex items-center gap-1 transition hover:opacity-75">
                  <svg
                    ...
                    className="dark:fill-foreground size-4">
                    <title>GitHub</title>
